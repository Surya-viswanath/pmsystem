...
//   try {
//     const response = await axios.put(`https://pmsystem-4.onrender.com/updateList/${id}`, updates);
...
const handleUpdate = async (id) => {
  try {
    await axios.put(`https://pmsystem-4.onrender.com/updateList/${id}`, updatedData);
