...
const handleSubmit =async(event)=>{
    ...
    try{
    const display =await axios.post('https://pmsystem-4.onrender.com/createpro',{userId: user._id,description,address,regularPrice,discountPrice,bathrooms,bedrooms,furnished,parking,type,offer,propertysize,phone,email,image,location,sell})
...
//     try {
//       const display = await axios.post('http://localhost:4008/createpro', {
//         userId: user._id, // Include user ID in the request
//         description,
//         address,
//         regularPrice,
//         discountPrice,
...
//   const types = ['Buy', 'Rent', 'commercial'];
//   const propertytypes = [
//     'Apartments', 'Villa', 'Townhouses', 'Land', 'Bungalows', 
//     'Hotel Apartments', 'Compounds', 'Full Floors', 'Half Floors'
//   ];
...
//           </div>
//         </div>
//         <Button type="submit" className='signbut' style={{float:'right'}}>
//           Add
//         </Button>
//       </Form>
//     </div>
