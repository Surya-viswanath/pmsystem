...
const Showrqst = () => {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                const res = await axios.get('https://pmsystem-4.onrender.com/request-organizer');
                setRequest(res.data);
            } catch (error) {
    ...
    const handleApprove = (userId, id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // axios.put(`https://pmsystem-4.onrender.com/getcustomer/organizer/${userId}`).then((res) => {
                    
                    // if (res.data.role === 'organizer') {
                        // console.log("accept",id);
                        axios.put(`https://pmsystem-4.onrender.com/request-organizer/accept/${id}`).then((res) => {
                            console.log("hey",id);
                            if (res.data.status === 'accepted') {
                                ...
                                axios.put(`https://pmsystem-4.onrender.com/update-user/${userId}`, { role: 'organizer' })
                                .then(response => {
    ...
    const handleReject = (id) => {
        console.log("hey",id);
        axios.put(`https://pmsystem-4.onrender.com/request-organizer/reject/${id}`).then((res) => {
